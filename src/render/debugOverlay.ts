...
const DISPLAY_ORDER = [
  ...
  "fieldMovementSampleCount", "fieldFlowXSum", "fieldFlowYSum", "fieldFlowMagnitudeSum", "fieldDynamicsMs", "fieldDynamicsActiveCellCount", "fieldDynamicsUpdatedCellCount", "fieldDynamicsTransferCount", "fieldDynamicsMagnitudeLoss", "fieldDynamicsMagnitudeAfter", "fieldRenderMs", "fieldRenderVectorCount", "fieldRenderTruncated",
