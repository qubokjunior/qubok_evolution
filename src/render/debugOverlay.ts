...
type OverlayGroupId = "runtime" | "field" | "controller" | "ecology" | "terrain" | "obstacle" | "movement" | "spatial" | "sensors" | "combat" | "resources" | "reproduction" | "worldSlots" | "other";
...
const DISPLAY_ORDER = [
  ...
  "controllerActuatorMs", "controllerActuatorEnabled", "controllerActuatorAgentCount", "controllerActuatorSampleCount", "controllerActuatorAffectedAgentCount", "controllerActuatorIgnoredDeadCount", "controllerActuatorZeroIntentCount", "controllerActuatorClampCount", "controllerActuatorForceMagnitudeTotal", "controllerActuatorMaxForceMagnitude", "controllerActuatorIntentMagnitudeTotal",
  "ecologyPressurePresetId", "ecologyPressureResourceTargetCount", "ecologyPressureResourceAliveCount", "ecologyPressureResourceRespawnedCount", "ecologyPressureFoodPickupCount", "ecologyPressureFoodEnergyTransferred", "ecologyPressureAverageEnergy01", "ecologyPressureMinimumEnergy01", "ecologyPressureMaximumEnergy01", "ecologyPressureStarvingCount", "ecologyPressureStarvationDamage", "ecologyPressureDeathsThisStep", "ecologyPressureBirthsThisStep", "ecologyPressureBlockedBirthsByCapacity", "ecologyPressurePredatorAttacksThisStep", "ecologyPressurePredatorKillsThisStep", "ecologyPressureAliveCount", "ecologyPressureCapacityCount", "ecologyPressureReusableSlotCount", "ecologyPressurePopulationPressure01",
...
const KEY_GROUPS: Record<string, OverlayGroupId> = Object.freeze({
  ...
  controllerActuatorMs: "controller",
  controllerActuatorEnabled: "controller",
  controllerActuatorAgentCount: "controller",
  controllerActuatorSampleCount: "controller",
  controllerActuatorAffectedAgentCount: "controller",
  controllerActuatorIgnoredDeadCount: "controller",
  controllerActuatorZeroIntentCount: "controller",
  controllerActuatorClampCount: "controller",
  controllerActuatorForceMagnitudeTotal: "controller",
  controllerActuatorMaxForceMagnitude: "controller",
  controllerActuatorIntentMagnitudeTotal: "controller",
  ecologyPressurePresetId: "ecology",
  ecologyPressureResourceTargetCount: "ecology",
  ecologyPressureResourceAliveCount: "ecology",
  ecologyPressureResourceRespawnedCount: "ecology",
  ecologyPressureFoodPickupCount: "ecology",
  ecologyPressureFoodEnergyTransferred: "ecology",
  ecologyPressureAverageEnergy01: "ecology",
  ecologyPressureMinimumEnergy01: "ecology",
  ecologyPressureMaximumEnergy01: "ecology",
  ecologyPressureStarvingCount: "ecology",
  ecologyPressureStarvationDamage: "ecology",
  ecologyPressureDeathsThisStep: "ecology",
  ecologyPressureBirthsThisStep: "ecology",
  ecologyPressureBlockedBirthsByCapacity: "ecology",
  ecologyPressurePredatorAttacksThisStep: "ecology",
  ecologyPressurePredatorKillsThisStep: "ecology",
  ecologyPressureAliveCount: "ecology",
  ecologyPressureCapacityCount: "ecology",
  ecologyPressureReusableSlotCount: "ecology",
...
const LABELS: Record<string, string> = {
  ...
  controllerActuatorMs: "ctrl act",
  controllerActuatorEnabled: "ctrl act on",
  controllerActuatorAgentCount: "ctrl act agents",
  controllerActuatorSampleCount: "ctrl act samples",
  controllerActuatorAffectedAgentCount: "ctrl act affected",
  controllerActuatorIgnoredDeadCount: "ctrl act dead ignored",
  controllerActuatorZeroIntentCount: "ctrl act zero",
  controllerActuatorClampCount: "ctrl act clamps",
  controllerActuatorForceMagnitudeTotal: "ctrl act force",
  controllerActuatorMaxForceMagnitude: "ctrl act max force",
  controllerActuatorIntentMagnitudeTotal: "ctrl act intent",
  ecologyPressurePresetId: "ec preset id",
  ecologyPressureResourceTargetCount: "ec food target",
  ecologyPressureResourceAliveCount: "ec food alive",
  ecologyPressureResourceRespawnedCount: "ec food respawn",
  ecologyPressureFoodPickupCount: "ec pickups",
  ecologyPressureFoodEnergyTransferred: "ec food energy",
  ecologyPressureAverageEnergy01: "ec avg energy",
  ecologyPressureMinimumEnergy01: "ec min energy",
  ecologyPressureMaximumEnergy01: "ec max energy",
  ecologyPressureStarvingCount: "ec starving",
  ecologyPressureStarvationDamage: "ec starve dmg",
  ecologyPressureDeathsThisStep: "ec deaths",
  ecologyPressureBirthsThisStep: "ec births",
  ecologyPressureBlockedBirthsByCapacity: "ec blocked births",
  ecologyPressurePredatorAttacksThisStep: "ec attacks",
  ecologyPressurePredatorKillsThisStep: "ec kills",
  ecologyPressureAliveCount: "ec alive",
  ecologyPressureCapacityCount: "ec capacity",
  ecologyPressureReusableSlotCount: "ec free slots",
  ecologyPressurePopulationPressure01: "ec pop pressure",
