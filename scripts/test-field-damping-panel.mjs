...
for (const token of ["DemoSimulationFieldDampingConfig", "DemoSimulationFieldDampingConfigPatch", "range.type = \"range\"", "input.type = \"checkbox\"", "number.type = \"number\"", "sliderMin", "sliderMax", "inputMin", "inputMax", "step", "updateFieldDampingConfig", "reset"]) assert(panel.includes(token), "fieldDampingPanel missing token: " + token);
