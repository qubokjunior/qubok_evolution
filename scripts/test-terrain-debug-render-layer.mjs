...
assert(packageJson.version === "0.1.0-milestone.40", "package.json must expose current m40 version.");
assert(appVersion.includes('PROJECT_VERSION = "0.1.0-milestone.40"'), "appVersion must expose current milestone.40.");
assert(appVersion.includes('PROJECT_MILESTONE = 40'), "appVersion must expose current milestone number 40.");
assert(appVersion.includes('PROJECT_MILESTONE_LABEL = "m40"'), "appVersion must expose current m40 label.");
